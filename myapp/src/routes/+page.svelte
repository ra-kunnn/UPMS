<script>
	import Header from '$lib/headerLanding.svelte';
    import Aside from '$lib/asideLanding.svelte';
...
<div class="min-h-screen flex-auto w-full h-full font-sans text-surface-900 bg-gradient-to-br from-primary-100 to-slate-300">
    ...
    <header class="relative ml-80">
        <div class="w-auto p-10">
            <div class="bg-gradient-to-br from-primary-500 via-indigo-600 to-surface-800 p-9 rounded-3xl text-white">
                <h1 class="h1 font-bold text-7xl pb-4">Welcome to UPMS!</h1>
                <blockquote class="blockquote text-white">quote, quote quote quote.</blockquote>
            </div>
            
            <hr class="my-10 h-0.5 border-t-0 bg-neutral-100 dark:bg-white/10" />

            <div>
                <h1 class="h1 font-bold pb-8">Available Rooms</h1>
