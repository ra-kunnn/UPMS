        ...
        <div class="w-auto p-10">
            <div>
                <div class="flex m-auto justify-between pb-8">
                    <h1 class="h1 font-bold my-auto">Visitor Logbook</h1>
                    ...
                    <table class="table table-fixed table-hover bg-surface-50">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Gian Plariza</td>
                                <td>Father</td>
                                <td>03/23/24, 13:00</td>
                                <td>03/23/24, 19:00</td>
                            </tr>
                            <tr>
                                <td>Redmund Rosales</td>
                                <td>Violette Rosales</td>
                                <td>Father</td>
                                <td>03/11/24, 19:00</td>
                                <td>03/12/24, 12:00</td>
                            </tr>
                            <tr>
                                <td>Jona Rosales</td>
                                <td>Violette Rosales</td>
